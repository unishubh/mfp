...
module.exports = class Receive {
    ...
    handleMessage () {
        ...
        try {
            if ( event.message ) {
                ...
                responses = this.handleFormCallBack();
            }
        } catch ( error ) {
            console.error(error);
            responses = {
    ...
    handlePayload (payload) {
        ...
        if (
            ...
            let curation = new Investment(this.user, this.webhookEvent);
            response = curation.handlePayload(payload);
        } else if ( payload.includes("PLAN") ) {
            let plan = new Plan(this.user, this.webhookEvent)
            response = plan.handlePayload(payload)
